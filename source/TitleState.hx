...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		starFG = new FlxBackdrop(Paths.image('starFG'), 1, 1, true, true);
		starFG.updateHitbox();
		starFG.antialiasing = true;
		starFG.scrollFactor.set();
		add(starFG);

		starBG = new FlxBackdrop(Paths.image('starBG'), 1, 1, true, true);
		starBG.updateHitbox();
		...
		titleText.frames = Paths.getSparrowAtlas('startText');
	...
	function createCoolText(textArray:Array<String>, ?offset:Float = 0)
	{
		for (i in 0...textArray.length)
		{
			...
			money.y += 40;
			FlxTween.tween(money, {y: money.y - 40}, 0.2, {ease: FlxEase.quadInOut});
			credGroup.add(money);
			textGroup.add(money);
		}
	}
	...
	function addMoreText(text:String, ?offset:Float = 0)
	{
		if(textGroup != null) {
			...
			coolText.y += 40;
			FlxTween.tween(coolText, {y: coolText.y - 40}, 0.2, {ease: FlxEase.quadInOut});
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['This is a mod based off of'], -60);
				case 7:
					addMoreText('vs impostor', -60);
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				// credTextShit.visible = false;
